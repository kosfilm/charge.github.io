...
// Спойлер.....................
$(document).ready(function () {
	$('.colums-item__title').click(function (event) {
		if ($('.colums-item').hasClass('one')) {
			$('.colums-item__title').not($(this)).removeClass('active');
			$('.colums-item__item').not($(this).next()).slideUp(600);
		}
